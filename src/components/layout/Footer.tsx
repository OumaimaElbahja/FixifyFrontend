      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">FixConnect</h3>
            <p className="text-gray-400 leading-relaxed">
              La plateforme qui vous connecte aux meilleurs réparateurs près de chez vous.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">Réparation smartphones</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Réparation tablettes</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Réparation ordinateurs</a></li>
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>© 2023 Fixify. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
